...
func (in *GcpNamespaceRestrictionSpec) DeepCopyInto(out *GcpNamespaceRestrictionSpec) {
	*out = *in
	if in.GcpRestriction != nil {
		in, out := &in.GcpRestriction, &out.GcpRestriction
		*out = make([]GcpRestrictionRoleBinding, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *GcpRestrictionRoleBinding) DeepCopy() *GcpRestrictionRoleBinding {
	...
	out := new(GcpRestrictionRoleBinding)
	in.DeepCopyInto(out)
	return out
}
...
func (in *GcpServiceAccountStatus) DeepCopyInto(out *GcpServiceAccountStatus) {
	*out = *in
	if in.AppliedGcpRoleBindings != nil {
		in, out := &in.AppliedGcpRoleBindings, &out.AppliedGcpRoleBindings
		*out = make([]GcpRoleBindings, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
